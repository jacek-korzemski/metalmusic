!(function (t, e) {
    ...
    var e =
        ...
        r = function (n) {
            ...
            return (
                (u.contentEditable = !0),
                (u.className = r.content),
                (u.oninput = function (t) {
                    var e = t.target.firstChild;
                    e && 3 === e.nodeType
                        ? f(l, "<" + i + ">")
                        : "<br>" === u.innerHTML && (u.innerHTML = ""),
                        n.onChange(u.innerHTML);
                }),
                (u.onkeydown = function (t) {
                    var e;
                    "Enter" === t.key &&
                        "blockquote" ===
                            ((e = l), document.queryCommandValue(e)) &&
                        setTimeout(function () {
                            return f(l, "<" + i + ">");
                        }, 0);
                }),
